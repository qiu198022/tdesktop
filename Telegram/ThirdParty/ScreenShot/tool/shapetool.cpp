...
void ShapeTool::initUI()
{
    ...
    btnBorder=new BaseButton(qCore->svgImagePath()+QStringLiteral("border-rect.png"),tr("Border"),this);
    btnFill=new BaseButton(qCore->svgImagePath()+QStringLiteral("filled-circle.png"),tr("Fill"),this);
    btnRectangle=new BaseButton(qCore->svgImagePath()+QStringLiteral("rectangular.png"),tr("Rectangle"),this);
    btnCircle=new BaseButton(qCore->svgImagePath()+QStringLiteral("circle.png"),tr("Circle"),this);
    btnTriangle=new BaseButton(qCore->svgImagePath()+QStringLiteral("triangle.png"),tr("Triangle"),this);
    btnRTriangle=new BaseButton(qCore->svgImagePath()+QStringLiteral("rtriangle.png"),tr("Vertical triangle"),this);
