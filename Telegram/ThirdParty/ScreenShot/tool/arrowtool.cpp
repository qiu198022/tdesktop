...
void ArrowTool::initUI()
{
    ...
    btnArrow1=new BaseButton(qCore->pngImagePath()+"tri-arrow.png",tr("Triangle Arrow"),this);
    btnArrow2=new BaseButton(qCore->pngImagePath()+"arrow.png",tr("Line Arrow"),this);
