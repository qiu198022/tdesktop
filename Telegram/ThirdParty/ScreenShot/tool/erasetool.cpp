...
void EraseTool::initUI()
{
    ...
    btnCircleErase=new BaseButton(qCore->pngImagePath()+"erase-rectangular0.png",tr("General erase"),this);
    btnRegionCircle=new BaseButton(qCore->pngImagePath()+"erase-rectangular.png",tr("Region erase"),this);
