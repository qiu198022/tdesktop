...
void PenTool::initUI()
{
    ...
    btnPoint=new BaseButton(qCore->pngImagePath()+QStringLiteral("dots.png"),tr("Point"),this);
    btnLine=new BaseButton(qCore->pngImagePath()+QStringLiteral("line.png"),tr("Line"),this);
    btnDashLine=new BaseButton(qCore->pngImagePath()+QStringLiteral("dashline.png"),tr("Dash Line"),this);
    btnCurve=new BaseButton(qCore->pngImagePath()+QStringLiteral("curve.png"),tr("Curve"),this);
