/****************************************************************************
** Meta object code from reading C++ file 'basebutton.h'
**
...
#error "The header file 'basebutton.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BaseButton_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject BaseButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QPushButton::staticMetaObject>(),
    qt_meta_stringdata_BaseButton.data,
    qt_meta_data_BaseButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BaseButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BaseButton.stringdata0))
