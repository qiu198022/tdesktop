...
QT_MOC_LITERAL(1, 11, 8), // "getColor"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 17) // "colorChangedEvent"

    },
    "ColorPanel\0getColor\0\0colorChangedEvent"
};
...
void ColorPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 1: _t->colorChangedEvent(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorPanel::getColor)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ColorPanel::getColor(const QColor & _t1)
{
