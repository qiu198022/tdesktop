...
QT_MOC_LITERAL(1, 15, 11), // "textUpdated"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 19), // "TextEditSizeChanged"
QT_MOC_LITERAL(4, 48, 15) // "emitTextUpdated"

    },
    "CustomTextEdit\0textUpdated\0\0"
    "TextEditSizeChanged\0emitTextUpdated"
};
...
void CustomTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->TextEditSizeChanged((*reinterpret_cast< const QRect(*)>(_a[1]))); break;
        case 2: _t->emitTextUpdated(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomTextEdit::textUpdated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CustomTextEdit::*)(const QRect & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomTextEdit::TextEditSizeChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CustomTextEdit::textUpdated(const QString & _t1)
{
...
// SIGNAL 1
void CustomTextEdit::TextEditSizeChanged(const QRect & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
