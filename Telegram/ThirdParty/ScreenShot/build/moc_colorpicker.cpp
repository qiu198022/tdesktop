...
QT_MOC_LITERAL(1, 12, 9), // "sendColor"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "ColorPicker\0sendColor\0"
};
...
void ColorPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendColor((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorPicker::sendColor)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ColorPicker::sendColor(QColor _t1)
{
