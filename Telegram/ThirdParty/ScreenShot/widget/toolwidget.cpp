...
void ToolWidget::initUI()
{
    ...
    btnShape=new BaseButton(qCore->svgImagePath()+QStringLiteral("shape.png"),tr("shape tool"),this);
    btnPen=new BaseButton(qCore->svgImagePath()+QStringLiteral("pen.png"),tr("pen tool"),this);
    btnText=new BaseButton(qCore->svgImagePath()+QStringLiteral("text.png"),tr("text tool"),this);
    btnArrow=new BaseButton(qCore->svgImagePath()+QStringLiteral("arrow.png"),tr("arrow tool"),this);
    btnBlur=new BaseButton(qCore->svgImagePath()+QStringLiteral("blur.png"),tr("blur"),this);
    btnBrush=new BaseButton(qCore->svgImagePath()+QStringLiteral("brush.png"),tr("Brush tool"),this);
    btnErase=new BaseButton(qCore->svgImagePath()+QStringLiteral("erase.png"),tr("erase tool"),this);
    btnUndo=new BaseButton(qCore->svgImagePath()+QStringLiteral("undo.png"),tr("undo"),this,false);
    btnRedo=new BaseButton(qCore->svgImagePath()+QStringLiteral("redo.png"),tr("redo"),this,false);
    btnCancel=new BaseButton(qCore->svgImagePath()+QStringLiteral("cancel.png"),tr("close"),this,false);
    btnPin=new BaseButton(qCore->svgImagePath()+QStringLiteral("pin.png"),tr("pin tool"),this,false);
    btnSave=new BaseButton(qCore->svgImagePath()+QStringLiteral("save.png"),tr("save to file"),this,false);
    btnCopy=new BaseButton(qCore->svgImagePath()+QStringLiteral("copy.png"),tr("copy to clipboard"),this,false);
